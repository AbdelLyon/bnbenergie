        ...
        <div className={tokens.layout.container}>
          <div className="flex h-16 items-center justify-between">
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <div className="min-w-0 flex-1">
                                          <div
                                            className={`text-[12.5px] font-semibold transition-colors duration-150 ${childActive ? "text-primary" : "text-foreground/85 group-hover:text-foreground"}`}
                                          >
                                            {link.label}
                                          </div>
                                          <p
            ...
            <LazyMotionButton
              ...
              className={`flex h-9 w-9 items-center justify-center rounded-xl ${tokens.transition.base} lg:hidden ${
                isScrolled
