...
export function StatCard({
  ...
  return (
    <LazyMotionDiv
      ...
      className={`group relative flex flex-col items-center justify-center overflow-hidden rounded-2xl border border-neutral-200/70 bg-white p-5 text-center shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] transition-all duration-300 hover:-translate-y-1 hover:border-primary-100 hover:shadow-[0_8px_24px_-6px_rgba(0,0,0,0.08)] dark:border-neutral-800 dark:bg-neutral-900 ${className}`}
    >
