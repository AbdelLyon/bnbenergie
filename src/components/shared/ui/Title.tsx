...
export function Title({
  ...
  return (
    <div className="text-center">
      <h1
        className={`px-4 text-5xl font-display font-bold tracking-tight  lg:text-6xl xl:text-6xl  ${spaceX}`}
      >
      ...
      {subtitle && (
        <h2 className="px-4 font-medium text-white text-lg lg:text-2xl xl:text-3xl mt-3 lg:mt-5">
          {subtitle}
        </h2>
      )}
    </div>
