...
export function Title({ staticText, animatedText, subtitle }: TitleProps) {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h1 className="font-display font-extrabold uppercase tracking-tight [text-shadow:0_1px_8px_rgba(0,0,0,0.4)]">
      ...
      {subtitle && (
        <Heading
          as="h2"
          className="font-display mt-3 md:mt-4 max-w-3xl text-[clamp(0.9rem,1.6vw,1.1rem)] text-white/80 font-semibold -tracking-tight"
        >
          {subtitle}
        </Heading>
      )}
