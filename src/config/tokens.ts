...
export const tokens = {
  ...
  bg: {
    ...
    navGlass: 'bg-black/40 backdrop-blur-sm', // navbar transparent sur hero
    ...
    hoverOutline: 'hover:bg-primary/10 hover:ring-1 hover:ring-primary/15',
    hoverOnDark: 'hover:bg-white/5', // hover sur surfaces sombres/transparentes
